...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        // Aplica migrações pendentes. Isso criará o banco de dados e todas as tabelas.
        context.Database.Migrate(); 
        
        // Se houver dados iniciais (Seed Data) para adicionar, o código viria aqui.
    }
    catch (Exception ex)
    {
        // Se a migração falhar (por exemplo, problema de conexão), isso será logado.
        var logger = services.GetRequiredService<ILogger<Program>>();
        logger.LogError(ex, "Ocorreu um erro ao migrar o banco de dados na inicialização.");
    }
}
...
// 2.5. Middleware de Diagnóstico (TEMPORÁRIO - REMOVER EM PRODUÇÃO)
